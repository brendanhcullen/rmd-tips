...
```{r penguins-plot, eval=plot_or_not, fig.path="my_figs/", dev=c("png","pdf"), dev.args=list(family='Palatino'), fig.cap = "My amazing penguins plot"}
penguins %>%
  ggplot(aes(
    x = bill_length_mm,
    y = bill_depth_mm,
...
- use `eval = <boolean_var>` for conditional evaluation
